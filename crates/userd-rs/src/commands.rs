...
pub fn run_groups<C: CommandExecutor>(cmd_executor: &C, username: &str) -> Vec<String> {
...
pub fn run_gpasswd_remove<C: CommandExecutor>(
    cmd_executor: &C,
    username: &str,
    group: &str,
...
pub fn run_groupadd<C: CommandExecutor>(cmd_executor: &C, group: &str) -> UserdResult<bool> {
...
pub fn run_useradd<C: CommandExecutor>(
    cmd_executor: &C,
    username: &str,
    home_dir: &str,
    shell: &str,
...
pub fn run_userdel<C: CommandExecutor>(cmd_executor: &C, username: &str) -> UserdResult<()> {
...
pub fn run_usermod_password<C: CommandExecutor>(
    cmd_executor: &C,
    username: &str,
    password_hash: &str,
) -> UserdResult<()> {
...
pub fn run_usermod_shell<C: CommandExecutor>(
    cmd_executor: &C,
    username: &str,
    shell: &str,
) -> UserdResult<()> {
...
pub fn run_usermod_add_group<C: CommandExecutor>(
    cmd_executor: &C,
    username: &str,
    group: &str,
) -> UserdResult<()> {
...
pub fn run_pkill<C: CommandExecutor>(
    cmd_executor: &C,
    username: &str,
    signal: &str,
) -> UserdResult<bool> {
