...
class TestProcessRebootCause(TestCase):
    ...
    @patch("process_reboot_cause.device_info.get_dpu_list", return_value=["dpu1", "dpu2"])
    @patch("os.path.isfile", return_value=True)
    @patch("process_reboot_cause.os.listdir", return_value=["/host/reboot-cause/module/dpu1/history/2024_12_13_01_12_36_reboot_cause.txt", "/host/reboot-cause/module/dpu1/history/2024_12_14_01_11_46_reboot_cause.txt"])
    @patch("process_reboot_cause.swsscommon.SonicV2Connector")
    @patch("process_reboot_cause.device_info.is_smartswitch", return_value=True)
    ...
    @patch("process_reboot_cause.device_info.get_dpu_list", return_value=["dpu1", "dpu2"])
    @patch("os.path.isfile", return_value=True)
    @patch("process_reboot_cause.os.listdir", return_value=["/host/reboot-cause/history/2024_12_13_01_12_36_reboot_cause.txt", "/host/reboot-cause/history/2024_12_14_01_11_46_reboot_cause.txt"])
    @patch("process_reboot_cause.swsscommon.SonicV2Connector")
